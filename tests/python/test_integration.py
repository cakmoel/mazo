...
from locustfile import RouteLoader, RouteDefinition, HTTPMethod
...
class TestRouteLoaderIntegration:
    ...
    def sample_routes_data(self):
        ...
        return {
            ...
            "comment-store": {
                "urls": [
                    "/post/8/cicero/comment",
                    "/post/6/kafka/comment"
                ],
                "methods": ["POST"],
...
class TestRouteLoaderEdgeCases:
    ...
    def test_missing_urls_field(self, tmp_path):
        ...
        routes_data = {
            "old_format": ["/old/path", "OldController@method"]
        }
